  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: "I am a full stack web developer from Birmingham, Alabama.  I create web applications that focus on clean interfaces, intuitive user experiences and reliability." }
    ],
    link: [
